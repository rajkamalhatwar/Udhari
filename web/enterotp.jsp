        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                  <h3 class="mb-3">Enter OTP to receive your password</h3>
                        ...
                        <div class="row">
                            <div class="col-md-7 pe-0">
                                <div class="form-left h-100 py-5 px-5">
                                    ...
                                    <form action="enterotp_server.jsp"  class="row g-4">
                                            <div class="col-12">
                                                <label>Enter OTP : <span class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <div class="input-group-text"><i class="bi bi-person-fill"></i></div>
                                                    <input id="txtotp" name="txtotp" type="text" class="form-control" placeholder="Enter OTP">
                                                     <small id="checkemail" class="text-danger input-group"></small>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <button type="submit" class="btn btn-warning px-4 float-end mt-4">Submit</button>
                                            </div>
